...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst mouseOut = (len, id, num) => {\n\n    let x;\n    let y;\n    if (num % 2 === 0) {\n        y = 0;\n        x = 1;\n    } else {\n        x = 0;\n        y = 1;\n    }\n    let i = id[y];\n    len = i + len;\n    for(i; i < len; i++) {\n        let coords = [];\n        coords[x] = id[x];\n        coords[y] = i;\n        document.getElementById(`p1:${coords}`).classList.remove(\"place-ship-hover\");\n    }\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (mouseOut);\n\n//# sourceURL=webpack://battleship_js/./src/mouseOut.js?");
